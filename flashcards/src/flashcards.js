(function () {
    ...
    function replace_card(card_ref, side_1, side_2, notes)
    {
        var card,
            new_note_created,
            note_refs,
    ...
    {
        return replace_card(current_card_ref, side_1, side_2, notes);
    }
    ...
    function run_tests()
    {
        ...
        QUnit.module("state_handling", function () {
            ...
            QUnit.test("replace_card", function(assert) {
                ...
                new_note_created = replace_card(
                    1,
                    "Card-2 Side-1 modified",
                    "Card-2 Side-2 modified",
                    ["  Note-2  ", "  Note-3  "]
                );
